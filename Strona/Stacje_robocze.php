    ...
    <nav class="navbar navbar-expand-lg navbar fixed-top menu" style="text-align: center; background-color: black;">
        ...
        <div class="row">
                <div class="col-lg-6 col-md-12 my-4">
                  <div class="row">
                    <div class="col-12">
                        <a href="Koputerykonfiguracja.html"><img src="zdj/Klasa_E.png" class="klasyzdj rounded mx-auto my-auto d-block" alt="KlasaE"></a>
                    </div>
                    <div class="col-12 mt-5">
                        <p class="opisklasy">Klasa E<br>
                            Full Tower<br>
                            Zrób więcej w krótszym czasie dzięki szybkiej i wydajnej
                            stacji roboczej od Digital Blizzard<br>
                            Wyposaż w stacje w najlepsze komponenty dostępne na rynku<br>
                            Procesory: Aż do 64 rdzeni do 5.3 Ghz<br>
                            Pamięć RAM: Aż do 1,5 TB<br>
                            Maksymalnie 4 karty graficzne<br>
                            Pamięć masowa: Aż do 48 TB</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-md-12 my-4">
                  <div class="row">
                    <div class="col-12">
                        <a href="Koputerykonfiguracja.html"><img src="zdj/Klasa_F.png" class="klasyzdj rounded mx-auto my-auto d-block" alt="KlasaF"></a>
                    </div >
                    <div class="col-12 mt-5">
                        <p class="opisklasy">Klasa F<br>
                            Montowanie do szafy Rack<br>
                            Zrób więcej w krótszym czasie dzięki szybkiej i wydajnej
                            stacji roboczej od Digital Blizzard<br>
                            Wyposaż w stacje w najlepsze komponenty dostępne na rynku<br>
                            Procesory: Aż do 64 rdzeni do 5.3 Ghz<br>
